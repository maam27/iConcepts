        ...
        <div class="register-section">
            ...
            <form method="Post" action="#">
                <div class="row">
                    <div class="col-md-6">
                        <p>Gebruikersnaam:</p>
                        <input id="username" name="username" type="text" placeholder="BarryBadpak" <?php echo post_set('username', 'post');?>>
                        <br>
                        <p>Wachtwoord:</p>
                        ...
                        <br>
                        <p>Voornaam:</p>
                        <input id="first-name" name="first-name" type="text" placeholder="Barry" <?php echo post_set('first-name', 'post');?>>
                        <br>
                        <p>Achternaam:</p>
                        <input id="last-name" name="last-name" type="text" placeholder="Badpak" <?php echo post_set('last-name', 'post');?>>
                        <br>
                        <p>Geboortedatum:</p>
                        <input id="birth-date" name="birth-date" type="date" <?php echo post_set('birth-date', 'post');?>>
                        <br>
                        <p>E-Mail:</p>
                        <input id="e-mail" name="e-mail" type="email" placeholder="E-mail" <?php echo post_set('e-mail', 'post');?>>
                        <br>
                    </div>
                    <div class="col-md-6">
                        <p>Land:</p>
                        <input id="country" name="country" type="text" placeholder="Nederland" <?php echo post_set('country', 'post');?>>
                        <br>
                        <p>Stad:</p>
                        <input id="city" name="city" type="text" placeholder="Arnhem" <?php echo post_set('city', 'post');?>>
                        <br>
                        <p>Adresregel 1:</p>
                        <input id="address-field" name="address-field" type="text" placeholder="Straatnaam 15" <?php echo post_set('address-field', 'post');?>>
                        <br>
                        <p>Adresregel 2:</p>
                        ...
                        <br>
                        <p>Postcode: </p>
                        <input id="postcode" name="postcode" type="text" placeholder="4323DK" <?php echo post_set('postcode', 'post');?>>
                        <br>
                        ...
                        <br>
                        <p>Antwoord:</p>
                        <input id="answer" name="answer" type="text" placeholder="Antwoord" >
                        <br>
