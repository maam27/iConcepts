    ...
    <div class="container">
        <div class="row seperator-bottom">
            ...
            <form class="row d-flex justify-content-center align-items-center seperator-bottom-md" method="post">
                ...
                <a class="btn btn-primary col-md-3 user-section-button-margin"
                   href="UpdateUserInformation.php">Pas wachtwoord aan</a>
                ...
                else{           echo '<a class="col-md-3 btn btn-primary user-section-button-margin" href="AanvraagVerkoperstatus.php"> Wordt Verkoper </a>   ';}
                ?>
            </form>
        </div>
</main>
